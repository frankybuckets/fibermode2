...
r_tube = 1.25e-5              # radius of inner tubes
r_core = r_tube            # radius of (computational) core region
r_fiber = 3 * r_tube           # radius of fiber, end of cladding region
...
n_tube = 1.450971                   # refractive index of tube material
n_clad = (n_tube*n_tube - .06*.06)**.5  # refractive index of cladding material
